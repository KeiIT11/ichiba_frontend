...
const Persona_card: React.FC<Personacardprops> = ({
    ...
    return (
        ...
        <div className="relative h-52 w-60 bg-white border">
            <div className="">
                <Image
                    alt={card_title}
                    src={card_url}
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white bg-opacity-60 p-16 backdrop-blur-[2px]">
            </div>
